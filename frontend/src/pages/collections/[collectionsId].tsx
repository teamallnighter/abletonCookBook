...
const EditCollections = () => {
  ...
  const { collectionsId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: collectionsId }))
  }, [collectionsId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: collectionsId, data }))
...
EditCollections.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
