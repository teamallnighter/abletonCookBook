...
const EditComments_reviews = () => {
  ...
  const { comments_reviewsId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: comments_reviewsId }))
  }, [comments_reviewsId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: comments_reviewsId, data }))
...
EditComments_reviews.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
...
export default EditComments_reviews
